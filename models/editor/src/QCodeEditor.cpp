...
#include "models/editor/includes/QSyntaxStyle.hpp"
#include "models/editor/includes/QLineNumberArea.hpp"
#include "models/editor/includes/QStyleSyntaxHighlighter.hpp"
#include "models/editor/includes/QFramedTextAttribute.hpp"
...
void QCodeEditor::keyPressEvent(QKeyEvent* e) {
  ...
  if (!completerSkip) {
    ...
    if (m_replaceTab && e->key() == Qt::Key_Backtab) {
      indentationLevel = indentationLevel > m_tabReplace.size() ? indentationLevel : m_tabReplace.size();
